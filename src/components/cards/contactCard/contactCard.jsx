        ...
        <div className="info">
          <div className="infoText">
            ...
            <ul className="contactList">
              <li>
                <PhoneIcon />
                <a href="tel:+37477667767" rel="noopener noreferrer">
                  (+374) 77-66-77-67
                </a>
              </li>
              <li>
                <MailIcon />
                <a
                  href="mailto:hamlet.araqelyan1995@gmail.com"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  hamlet.araqelyan1995@gmail.com
                </a>
              </li>
              <li>
                <TelegramIcon />
          ...
          <div className="infoText">
            ...
            <ul className="contactList">
              <li>
                ...
                <a
                  target="_blank"
                  href="https://www.linkedin.com/in/hamlet-araqelyan-a600b81a4/"
                  rel="noopener noreferrer"
                >
                  Linkedin
                </a>
